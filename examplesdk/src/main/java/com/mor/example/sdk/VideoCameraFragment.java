...
//        view.findViewById(R.id.info).setOnClickListener(this);
            ...
            if (grantResults.length == VIDEO_PERMISSIONS.length) {
                for (int result : grantResults) {
                    if (result != PackageManager.PERMISSION_GRANTED) {
                        ErrorDialog.newInstance("I need your premission in order to show you how this works")
    ...
    private void openCamera( int width, int height) {
        ...
        if (!hasPermissionsGranted(VIDEO_PERMISSIONS)) {
            requestVideoPermissions(activity);
            return;
        }
        ...
        try {
            ...
            ErrorDialog.newInstance("Are you sure you have a Camera? Can't find it...")
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } catch (InterruptedException e) {
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage("I need your premission in order to show you how this works")
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
